...
const handleAnimalFormSubmit = event => {
  ...
  // This will allow the request to make it to the proper endpoint in our server, which is the one we created (app.post("/api/animals") to add new animals to the JSON file
  fetch('/api/animals', {
    method: 'POST',
    headers: {
